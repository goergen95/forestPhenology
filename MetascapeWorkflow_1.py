...
imgPath = "X:/nature40/2019_05_16_core14"       # path to images							sys.argv[2]
projName = "2019_05_16_core14.psx"      # project name with suffix ".psx"		sys.argv[3]
	...
	if goal == "allOrtho":			
		...
		for chunk in doc.chunks:
			...
			if (noPoints == False):    
				...
				chunk.exportOrthophotos(imgPath + "/" + chunk.label + ".tif", projection=crs, raster_transform=Metashape.RasterTransformNone,
				write_kml=True, write_world=True, write_alpha=True, tiff_big=True, tiff_compression="none", white_background=True,dx=orthoRes,dy=orthoRes)
