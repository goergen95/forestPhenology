...
author: 
- Darius Görgen (`r config::get(file = "config.yml")$darius`)
- Tobias Koch (`r config::get(file = "config.yml")$tobi`)
- Marvin Müsgen (`r config::get(file = "config.yml")$marvin`)
- Eike Schott (`r config::get(file = "config.yml")$eike`)
