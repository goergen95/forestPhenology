...
The study area is located at 50.8Â°N 8.7Â°E in the German low mountain range in Hesse.
...
The area is approximately 37,500 mÂ² and continuously covered by trees. In this
...
--> Vielleicht nochmal erwähnen, dass das die grundlage war und nicht unser verschulden?
...
--> Vielleicht erwhnen, dass saisonale indices besser sein könnten, nur für den geeigneten zeitraum evtl kein Bild vorhanden war, beispielsweise irgendein saisonales merkmal wegen der zeit verpasst wurde. ich denke da an abbildung 3 in unserem bericht?
--> vielelicht noch auf die indices eingehen warum gerade diese ausgewählt wurden?
...
also warum wurden gerade RCC GCC GLI UND VVI ausgewählt? kenne da gerade keine Begründung. gibts da eine=
-->  WIe siehts damit aus, dass die indices eigentlich für satelliten und luftbilder entwickelt wurden. hat das einen einfluss auf drohnenbilde und daher auf die auswahl. also werden bestimmte indices aufgrund des anders einfallenden lichts bevorzugt? und deshalb ausgewöhlt?
--> gibts nen bezug den man zur einleitung ziehen kann?
--> WIr haben mehr buchen im untersuchung und traininsgebiet führt das dazu, dass buchen besser vorhergesagt werden und daher die Modellgüte künstlich erhöht wird?
