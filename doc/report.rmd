...
contribute to seasonally differntiate tree green-up and senescence
in different forest envrionments.
...
temporal and seasonal paramters, increases the OA at a rate of about 1%.
...
the accuracy of object classification increases from a resolution of 10 cm to a 
...
a forest stand in the warm and humid climate close to Kyoto.
...
Additionally, sources of error in the database should can significantly influence
the outcome of any classification process. The images used in this study
are prone to a number of sources of errors. Firstly, we observed inconsistencies 
in the process of georefferencing the images which led to rather large image distortions (Fig. 2). 
...
high margins of error [@Fraser2018a]. Another issue, are the differences 
in illumination and viewing geometry which seriously limits the comparability
of images from different days or different paths [@Fraser2018a; @Fricker2019; @Sonnentag2012].
