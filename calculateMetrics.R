...
raster::writeRaster(metrics, filname=paste0("data/season/season_TGI_",r,".tif"))
metrics = calcPheno(GLI) 
raster::writeRaster(metrics, filname=paste0("data/season/season_GLI_",r,".tif"))
metrics = calcPheno(CIVE) 
raster::writeRaster(metrics, filname=paste0("data/season/season_CIVE_",r,".tif"))
metrics = calcPheno(IO) 
raster::writeRaster(metrics, filname=paste0("data/season/season_IO_",r,".tif"))
metrics = calcPheno(VVI) 
raster::writeRaster(metrics, filname=paste0("data/season/season_VVI_",r,".tif"))
metrics = calcPheno(GCC) 
raster::writeRaster(metrics, filname=paste0("data/season/season_GCC_",r,".tif"))
metrics = calcPheno(RCC) 
raster::writeRaster(metrics, filname=paste0("data/season/season_RCC_",r,".tif"))
print(r)
