...
raster::writeRaster(metrics, filename=paste0("data/season/season_TGI_",r,".tif"))
print("Finished TGI parameters.")
metrics = calcPheno(GLI) 
raster::writeRaster(metrics, filename=paste0("data/season/season_GLI_",r,".tif"))
print("Finished GLI parameters.")
metrics = calcPheno(CIVE) 
raster::writeRaster(metrics, filename=paste0("data/season/season_CIVE_",r,".tif"))
print("Finished CIVE parameters.")
metrics = calcPheno(IO) 
raster::writeRaster(metrics, filename=paste0("data/season/season_IO_",r,".tif"))
print("Finished IO parameters.")
metrics = calcPheno(VVI) 
raster::writeRaster(metrics, filename=paste0("data/season/season_VVI_",r,".tif"))
print("Finished VVI parameters.")
metrics = calcPheno(GCC) 
raster::writeRaster(metrics, filename=paste0("data/season/season_GCC_",r,".tif"))
print("Finished GCC parameters.")
metrics = calcPheno(RCC) 
raster::writeRaster(metrics, filename=paste0("data/season/season_RCC_",r,".tif"))
